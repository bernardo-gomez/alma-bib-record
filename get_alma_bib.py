...
def marcxml_to_marcedit(xml_string):
    """ it converts marcxml to terry reeses' application format. see http://marcedit.reeset.net/features .
...
def get_bib_string(bib_xml):
   """ it receives an xml string and it adds the header to make it a marcxml string."""
   bib_string=""
   outcome=1
...
def api_request(host,request_data):
   ...
   """ it performs a GET request through the url. url is composed of host and request_data. a 
